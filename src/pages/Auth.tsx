              ...
              {isSignUp && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 bg-transparent border-border/30 text-foreground placeholder:text-muted-foreground/60 focus:border-primary/50 focus:bg-background/5"
                    required
                  />
                </div>
              )}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 bg-transparent border-border/30 text-foreground placeholder:text-muted-foreground/60 focus:border-primary/50 focus:bg-background/5"
                    required
                  />
                </div>
              </div>
